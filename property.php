                                ...
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        ...
                                        <form method="post">
                                            ...
                                            <input type="hidden" name="pimage" value="<?php echo $row['18']; ?>">
                                            <input type="hidden" name="pname" value="<?php echo $row['1']; ?>">
                                            <input type="hidden" name="pprice" value="<?php echo $row['13']; ?>">
                                            <input type="number" name="quantity" value="1" min="1">
                                            <button class="add-to-cart-btn btn btn-primary" name="add_to_cart">Add to Cart</button>
                                        </form>
