                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">Collins Street West, Victoria 8007, Nigeria</span> 
										<span class="text-secondary">Collins Street West, Victoria 8007, Nigeria</span>
										</div>
                                </li>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="d-table text-secondary">helpline@praise.com</span>
										<span class="text-secondary">helpline@praise.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
